...
export default (state = initialState, action: any) => {
  switch (action.type) {
    ...
    case 'GAME_NUMBERS_FETCH':
      //console.log('GAME_NUMBERS_FETCH: ' + JSON.stringify(gameNumbers));
      ...
      var autoNumbers = userNumbers.filter((item) => item.autogenerated == 1);
      var manualNumbers = userNumbers.filter((item) => item.autogenerated != 1);
